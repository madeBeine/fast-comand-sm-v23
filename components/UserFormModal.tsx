                ...
                <div className="flex-grow overflow-y-auto p-6 space-y-8 custom-scrollbar">
                    ...
                    {formData.role === 'admin' ? (
                        ...
                        <div className="space-y-6">
                            ...
                            {/* Group 1: High Level System & Finance */}
                            <div>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                                    <PermissionCheckbox 
                                        ...
                                        checked={formData.permissions?.canViewFinance ?? false} 
                                        onChange={(v) => handlePermissionChange('canViewFinance', '', v)} 
                                        highlight={true}
                                    />
                                    <PermissionCheckbox 
                                        label="عرض سجل النظام" 
                                        checked={formData.permissions?.canViewAuditLog ?? false} 
                                        onChange={(v) => handlePermissionChange('canViewAuditLog', '', v)} 
                                    />
                                    <PermissionCheckbox 
                                    ...
                                    />
                                    <PermissionCheckbox 
                                        label="الدخول لصفحة الإعدادات" 
                                        checked={formData.permissions?.canAccessSettings ?? false} 
                                        onChange={(v) => handlePermissionChange('canAccessSettings', '', v)} 
                                    />
                                </div>
                            </div>

                            {/* Group 2: Operations Modules */}
                            <div>
                            ...
                            {/* Group 4: Configuration (Only if Settings Access is ON) */}
                            {formData.permissions?.canAccessSettings && (
                                <div className="animate-in fade-in slide-in-from-top-2">
                                    <h4 className="font-bold text-gray-700 dark:text-gray-300 mb-3 flex items-center gap-2">
                                        ...
                                        <span className="text-xs font-normal text-gray-500">(يتطلب تفعيل "الدخول لصفحة الإعدادات" أعلاه)</span>
                                    </h4>
