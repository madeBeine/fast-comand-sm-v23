...
const SETTINGS_NAV = [
    ...
    { id: 'system', label: 'إعدادات النظام', icon: Settings, helpKey: 'system' as const },
    { id: 'data_management', label: 'إدارة البيانات', icon: FileSpreadsheet, helpKey: 'system' as const },
    ...
    { id: 'users', label: 'المستخدمين', icon: Users, helpKey: 'user_role_admin' as const },
    { id: 'audit', label: 'سجل العمليات', icon: FileText, helpKey: 'system' as const },
];
                    ...
                    <div key={store.id} className="bg-white dark:bg-gray-800 p-4 rounded-xl border dark:border-gray-700 shadow-sm relative group hover:shadow-lg transition-all">
                        ...
                        <div className="flex flex-col items-center text-center gap-3 mt-2">
                            <div className="w-16 h-16 rounded-xl bg-gray-100 dark:bg-gray-700 flex items-center justify-center overflow-hidden border dark:border-gray-600 shadow-inner shrink-0">
                                {store.logo ? <img src={store.logo} className="w-full h-full object-contain"/> : <ShoppingBag className="text-gray-300" size={32}/>}
                            </div>
                            <div>
